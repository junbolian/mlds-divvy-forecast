...
## 0. Project Preview
Below are examples of the visual outputs generated by this pipeline.

**1. Interactive Divvy Map (Folium)**

Shows live station status, occupancy, and demand index.

<img src="images/map.png" width="650">

**2. Top 10 Stations by Average Occupancy**
